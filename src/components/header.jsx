import {Dropdown, Button, Flex, Typography, ConfigProvider, Anchor} from 'antd'
import { ContactsOutlined, BookOutlined, ProjectOutlined, CustomerServiceOutlined, PhoneOutlined, DownloadOutlined } from '@ant-design/icons'
    ...
    return (<>
        ...
        <div className='header-presentation'>
            <Flex vertical justify='center' align='center'>
                ...
                <Title style={{fontSize: '1rem', color: 'rgb(62, 78, 92)', marginBottom: '30px'}}>Front-end developer & UI Designer</Title>
                <Button icon={<DownloadOutlined></DownloadOutlined>}  classNames='fluent' type='primary' aria-label='click to download cv'>DOWNLOAD CV</Button>
                <div style={{position: 'relative'}}><img src="/pngtree__photo1.png" alt="web development illustration" className='background' />
                    <div className='info'></div>
                </div>
            </Flex>
        </div>
        <summary>
            <Title id='about'><LinearGradient gradient={["to right", "#00afff, #00ff8f"]}>ABOUT ME</LinearGradient></Title>
            <Paragraph style={{fontSize: '0.8rem', textAlign: 'justify', fontFamily: 'dana light, sans-serif'}}>I am a 19-year-old <em>computer science student</em>. I am passionate about <em>web design and development</em>, and I always bring a touch of innovation to my projects for my own satisfaction and for my clients' satisfaction.</Paragraph>
        </summary>
    </>)
}